...
public class Gabarito {
    ...
    public static final String R2 = "Operador this serve para exclarecer redundâncias entre atributos de classe e variáveis de lista de argumentos, e não deve ser usado quando não houver redundância. Exemplo: É usado para esclarecer em qual activity a mensagem da classe Toast deve ser exibida, ou em qual posição da lista de Activitys o Intent deve abrir outra Activity.";
    public static final String R3 = "Denomidador de acesso da classe, palavra reservada class PrimeiraLetraMaiúscula de cada palavra, sem espaço em branco entre as palavras do nome da classe.";
    ...
    public static final String CABECALHO_TOOLBAR = "DESENVOLVEDORES EM TI";
